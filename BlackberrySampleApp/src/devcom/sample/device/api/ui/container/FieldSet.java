...
public class FieldSet extends VerticalFieldManager {
	...
	public FieldSet(String title, Border titleBorder, Border contentBorder,
			long style) {
		super(style);
	...
	protected static class FieldSetBorder extends Border {
		protected String _title;
		protected Font _font;
		protected Border _titleBorder;
		protected Border _contentBorder;

		protected Background _titleBackground;

		protected int _titleAreaHeight;
		protected int _titleBorderTopAndBottom;
		protected int _titleBorderLeftAndRight;

		protected XYRect _paintRect = new XYRect();

		public FieldSetBorder(String title, Font font, Border titleBorder,
			...
			_titleAreaHeight = titleBorder.getTop() + font.getHeight()
					+ titleBorder.getBottom();
			_titleBorderTopAndBottom = titleBorder.getTop()
					+ titleBorder.getBottom();
			_titleBorderLeftAndRight = titleBorder.getLeft()
					+ titleBorder.getRight();
		}

		public static XYEdges getComposedBorderEdges(Font font,
				Border titleBorder, Border contentBorder) {
